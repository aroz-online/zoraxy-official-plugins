...
# Check for -noclone argument anywhere in the arguments
if [[ " $@ " =~ [[:space:]]-noclone[[:space:]] ]]; then
    echo "Skipping repository clone and plugin replacement due to -noclone flag."
else
